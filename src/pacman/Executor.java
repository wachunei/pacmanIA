...
public class Executor {
	...
	public static void main(String[] args) {
		...
		// Run a single game in asynchronous mode.
		exec.runGameTimed(
				pacmanController,
				ghostController,
				visual);
		...
		// Run the game in asynchronous mode but advance as soon as
		//   both controllers are ready - this is the mode of the competition.
		// Time limit of DELAY milliseconds still applies.
		/*
		 * boolean visual=true;
		 * boolean fixedTime=false;
		 * exec.runGameTimedSpeedOptimised(
		 *   new RandomPacMan(),
		 *   new RandomGhosts(),
		 *   fixedTime,
		 *   visual);
		 ...
		 * exec.runGameTimedRecorded(
		 *   new HumanController(new KeyBoardInput()),
		 *   new RandomGhosts(),visual,
		 *   fileName);
	 ...
	 * against a chosen opponent: the random nature of the game means that performance can vary from game to game. Running
	 * many games and looking at the average score (and standard deviation/error) helps to get a better idea of how well
	 * the controller is likely to do in the competition.
	 *
	 ...
	 * controllers return very quickly, a time limit can be used. If fasted gameplay is required, this delay should be put
	 * as 0.
	 *
	 * @param pacManController
	 *          The Pac-Man controller
